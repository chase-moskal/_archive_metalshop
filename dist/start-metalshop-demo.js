...
function modifyMetalConfigBasedOnQueryParams() {
    ...
    const attr = (key, value) => config.setAttribute(key, value);
    if (query.mock !== undefined) {
        attr("mock", query.mock);
        if (query.mock.includes("open")) {
            setTimeout(() => {
                document.querySelector("menu-system > menu-display:nth-child(1)")?.toggle();
            }, 0);
        }
    }
...
//# sourceMappingURL=start-metalshop-demo.js.map