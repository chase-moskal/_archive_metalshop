import { User, Profile, Question, Settings, CardClues, AuthTokens, AccessToken, ScheduleEvent, QuestionDraft, AuthDealerTopic, TokenStoreTopic, PaywallLiaisonTopic, ScheduleSentryTopic, SettingsSheriffTopic, QuestionsBureauTopic, LiveshowGovernorTopic, ProfileMagistrateTopic } from "authoritarian/dist/interfaces.js";
...
export declare type ConstructorFor<T extends {} = {}> = new (...args: any[]) => T;
...
export declare type GetAuthContext = () => Promise<AuthContext>;
export declare type TriggerAccountPopup = () => Promise<AuthTokens>;
export declare type DecodeAccessToken = (accessToken: AccessToken) => AuthContext;
export declare type TriggerCheckoutPopup = (o: {
...
export declare type PrepareHandleLikeClick = (o: {
    like: boolean;
    questionId: string;
...
export declare enum ProfileMode {
    Error = 0,
    Loading = 1,
    Loaded = 2,
    None = 3
}
export declare enum BillingPremiumSubscription {
    Unsubscribed = 0,
    Subscribed = 1
}
