...
import {ProfileUpdateEvent} from "../system/events.js"
import {AvatarReadAccess} from "../system/interfaces.js"
...
export class UserButton extends LitElement {
	@property({type: Object}) avatarReadAccess: AvatarReadAccess
	...
	protected _handleProfileLoaded = (event: ProfileUpdateEvent) => {
		const {profile} = event.detail
		this.picture = profile
			? html`<img src=${profile.public.picture} alt="[your profile picture]"/>`
			: this.defaultPicture
	}
